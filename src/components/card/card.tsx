...
const Card = ({ image, smallText, title, price, description }: CardProps) => {
  ...
  return (
    <div className="bg-white  p-4 rounded-lg w-full my-10 border border-[#c1c4cc]">
      <div className=" flex flex-wrap md:grid md:grid-cols-[auto_1fr_auto] gap-4  relative  ">
        {/* First Column - Image */}
        <div className="w-24 h-24 sm:w-full sm:h-32 flex-shrink-0">
          <Image
            height={100}
            width={500}
            src={image}
        ...
        <div className="flex-1 w-full">
          ...
          <p className="text-[#303437] mt-2 text-[14px] font-extralight tracking-wide">
            {showFullText
              ? description
        ...
        <div className="flex flex-col items-end gap-4 w-full md:w-auto">
          ...
          <button className="bg-[#00a862] cursor-pointer hover:opacity-45 hover:drop-shadow-2xl delay-150 ease-in-out decoration-2 !text-white font-semibold  px-5 py-3 rounded-xs text-xs sm:text-sm w-full md:w-auto">
            Shop Now
          </button>
        </div>
