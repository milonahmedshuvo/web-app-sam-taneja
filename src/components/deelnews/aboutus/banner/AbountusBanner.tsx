  ...
  return (
    <div className='relative bg-cover bg-no-repeat bg-center h-[500px] mt-4 bg-[#121B51]' style={{backgroundImage: `url('${aboutusbanner.src}')`}} >
          ...
          <div className='relative z-10 flex justify-center items-center h-full' >
               ...
               <p className='text-[18px] font-[500px] text-white text-center flex justify-center gap-2 cursor-pointer'> <Link href='/'>Home </Link>  <FaChevronRight/> <span>About Us</span> </p>
               </div>
          </div>
    </div>
  )
