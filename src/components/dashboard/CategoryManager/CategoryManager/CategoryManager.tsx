...
//           ? {
//               ...category,
//               isAddingSubcategory: !category.isAddingSubcategory,
//               newSubcategoryName: "",
//             }
//           : category
//       )
...
//                   ? {
//                       ...subcategory,
//                       isAddingChild: !subcategory.isAddingChild,
//                       newChildName: "",
//                     }
//                   : subcategory
//               ),
...
//       categories.map((category) =>
//         category.id === categoryId
//           ? { ...category, newSubcategoryName: value }
//           : category
//       )
//     );
//   };
...
//               subcategories: category.subcategories.map((subcategory) =>
//                 subcategory.id === subcategoryId
//                   ? { ...subcategory, newChildName: value }
//                   : subcategory
//               ),
//             }
//           : category
...
//                     <div
//                       key={subcategory.id}
//                       className="grid grid-cols-12 p-2 ml-6"
//                     >
//                       <div className="col-span-6 flex items-center gap-2">
//                         <button
//                           onClick={() =>
...
//                         </button>
//                         <span>
//                           {subcategory.name} ({subcategory.children.length})
//                         </span>
//                       </div>
...
//                         <button
//                           onClick={() =>
//                             toggleAddChildCategory(category.id, subcategory.id)
//                           }
//                         >
//                           <Plus className="h-4 w-4" />
//                         </button>
...
//                               <button
//                                 onClick={() =>
//                                   saveChildCategory(category.id, subcategory.id)
//                                 }
...
//                       </button>
//                       <button
//                         onClick={() => toggleAddSubcategory(category.id)}
//                         className="text-red-500"
//                       >
//                         Cancel
//                       </button>
