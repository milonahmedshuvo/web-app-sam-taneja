...
const projects: Project[] = [
  ...
  },
  {
    ...
    timeTitle: "AliExpress 2 day ago",
    price: "$500",
    name: "MLILY Fusion Supreme 11.5″ Hybrid Luxury..",
    image:
  ...
  return (
    <div className="relative p-4  ">
      {canScrollLeft && (
        <button
          onClick={() => scroll("left")}
          className="absolute left-0 top-1/2 -translate-y-1/2 p-1 cursor-pointer bg-[#fff] drop-shadow-lg text-white rounded-full "
        >
          {/* &#9664; */}
